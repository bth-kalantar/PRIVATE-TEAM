...
local lang = redis:get(hash)
   ...
   if not lang then
     ...
     return '#》_شما مدیر ربات نیستید پس زور نزن لطفا_🚷'
    end
end
...
if not lang then
   ...
   message = '☆》📋لیست معاون های دیوس گروه \n'
end
...
if not lang then
 ...
 return "#》_شما مدیر ربات نیستید پس زور نزن _🚷"
end
end
...
return "#》_شما مدیر ربات نیستید پس زور نزن_🚷"
end
end
...
if not lang then
 ...
 return "#》_شما مدیر ربات نیستید پس لطفا زور نزن _🚷"
end
end
...
return "#》_شما مدیر ربات نیستید پس لطفا زور نزن_🚷"
end
end
...
if not lang then
 ...
 return "#》_شما مدیر ربات نیستید پس لطفا زور نزنید _🚷"
end
end
  ...
  if matches[1] == 'تنظیم حساسیت' and is_mod(msg) then
   ...
   tdcli.changeChannelAbout(chat, "", dl_cb, nil)
    ...
    if matches[1]:lower() == 'پاک کردن' and is_admin(msg) then
      if matches[2] == 'لیست مدیران دیوس ' then
